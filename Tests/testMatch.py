...
class TestMatch(unittest.TestCase):
    def test_get_matched_user(self):
        userId = 12
        exp_d = {"response": "Success", "userIds": [11], "firstnames": ["Melody Lui"], "currentName": "melo3"}
        d = matchUser(userId)
    ...
    def test_get_matched_user_multiple(self):
        userId = 11
        exp_d = {"response": "Success", "userIds": [12, 10], "firstnames": ["melo3","melo"], "currentName": "Melody Lui"}
        d = matchUser(userId)
        self.assertEqual(exp_d, d)
